---
title: Notes - Runnin' Down a Dream
description: Excerpts from "Runnin' Down a Dream" by Bill Gurley
date: 2026-03-13
labels: ["book"]
---
...
1.  **Myers-Briggs Test:** Use this to identify your psychological type and match it to established career tables (e.g., s often excel as investors).
2.  **Loves and Strengths Exercise:** Divide a paper in half. List what you love on the left and what you are good at on the right. Search for careers that intersect at the middle.
3.  **Life Design Compass:** Write two 250-word essays: "What is work for?" and "What is a good life?" Look for careers that create coherence between these values.
4.  **Odyssey Plan:** Build three different five-year plans for your career. This allows you to "dream" and assess your potential feelings at the end of each path.
...
1.  **Foundational History:** You must study the pioneers and the bedrock of your field. This serves as a test: if the history of the field bores you, it is not youscination.
2.  **Continuous Learning:** You must proactively add knowledge on your own time, outside of what your company provides.
3.  **Unique Knowledge:** Look for "holes" or unexploited pockets in your industry that your peers are missing.
4.  **Far Analogies (Lateral Learning):** Breakthroughs often come from borrowing ideas from unrelated fields. For example, Charles Darwin had his biology breakthrough after reading about geology.
...
1.  **Depth of Passion:** You must ensure your interest is a deep, abiding curiosity rather than a passing fad.
2.  **The Hard Work Requirement:** Principles are not a substitute for **effort and pain**; they are tools that, when combined with a tremendous amount of work, lead to success.
