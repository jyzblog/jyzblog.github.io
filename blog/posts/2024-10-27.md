...
A simplified model can represent this relationship, where **B(t)** represents brand value over time (**t**). The higher the **B(t)**, the stronger the brand and the greater the potential price premium the company can charge.
