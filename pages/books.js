    ...
    <div className={styles.content}>
      ...
      <ul>
        ...
        <Book
          ...
          author="Seth Klarman"
          hashtags={['value']} />
        <Book title="Security Analysis: Principles and Technique"
        ...
        <Book title="Common Stocks and Uncommon Profits and Other Writings"
          ...
          author="Phil Fisher"
          hashtags={['stock']} />
        <Book title="The Man Who Solved the Market: How Jim Simons Launched the Quant Revolution"
        ...
        <Book title="A Man for All Markets: From Las Vegas to Wall Street, How I Beat the Dealer and the Market"
          address="https://amzn.to/36lubdo"
          author="Edward O. Thorp"
          hashtags={['biography']} />
        <Book title="King of Capital: The Remarkable Rise, Fall, and Rise Again of Steve Schwarzman and Blackstone"
          address="https://amzn.to/2IfcjIZ"
          author="David Carey"
          hashtags={['Schwarzman', 'blackstone', 'biography']} />
        <Book title="The Mathematics of Gambling"
          address="https://amzn.to/3eJiHnB"
          author="Edward O. Thorp"
          hashtags={['mathematics', 'gambling']} />
        <Book title="The Mathematics of Games and Gambling"
          address="https://amzn.to/3p8vHIo"
          author="Edward Packel"
          hashtags={['mathematics', 'gambling']} />
        <Book title="Probability Guide to Gambling: The Mathematics of Dice, Slots, Roulette, Baccarat, Blackjack, Poker, Lottery and Sport Bets"
        ...
        <Book title="Antifragile: Things That Gain from Disorder"
          ...
          author="Nassim Taleb"
          hashtags={[]} />
        <Book title="Fooled by Randomness: The Hidden Role of Chance in Life and in the Markets"
      ...
      <ul>
        <Book title="Zero to One"
          ...
          author="Peter Thiel"
          hashtags={['monopoly']} />
        <Book title="High Growth Handbook"
          address="https://amzn.to/3ezKSW6"
          author="Elad Gil"
          hashtags={['growth']} />
        <Book title="Hackers & Painters: Big Ideas from the Computer Age"
        ...
        <Book title="Measure What Matters: How Google, Bono, and the Gates Foundation Rock the World with OKRs"
          address="https://amzn.to/356ek2S"
          author="John Doerr"
          hashtags={['metrics', 'data']} />
        <Book title="Scale: The Universal Laws of Growth, Innovation, Sustainability, and the Pace of Life in Organisms, Cities, Economies, and Companies"
          address="https://amzn.to/38kQqT4"
          author="Geoffrey West"
          hashtags={['growth']} />
        <Book title="Blitzscaling: The Lightning-Fast Path to Building Massively Valuable Companies"
          address="https://amzn.to/3ezLdIm"
          author="Reid Hoffman"
          hashtags={['LinkedIn', 'growth']} />
        <Book title="The Entrepreneur's Guide to Customer Development: A cheat sheet to The Four Steps to the Epiphany"
        ...
        <Book title="Founding Sales"
          address="https://FoundingSales.com"
          author="Pete Kazanjy"
          hashtags={['growth', 'sales']} />
        <Book title="The Morando Method"
          address="https://amzn.to/3k9PMu2"
          author="Mitchell Morando"
          hashtags={['growth', 'sales']} />
        <Book title="Venture Deals: Be Smarter Than Your Lawyer and Venture Capitalist"
          address="https://amzn.to/3paRHC6"
          author="Brad Feld"
          hashtags={['fundraising', 'VC']} />
        <Book title="The Fundraising Rules"
          address="https://amzn.to/2JMiEfs"
          author="Mark Peter Davis"
          hashtags={['fundraising']} />
        <Book title="Secrets of Sand Hill Road: Venture Capital and How to Get It"
          address="https://amzn.to/2GHEKi0"
          author="Scott Kupor"
          hashtags={['fundraising', 'VC']} />
        <Book title="The Hardware Startup: Building Your Product, Business, and Brand"
      ...
      <ul>
        <Book title="The Culture Code: The Secrets of Highly Successful Groups"
          address="https://amzn.to/2IeOYqQ"
          author="Daniel Coyle"
          hashtags={['management', 'culture']} />
        <Book title="What You Do Is Who You Are: How to Create Your Business Culture"
          address="https://amzn.to/3mZORyb"
          author="Ben Horowitz"
          hashtags={['management', 'culture', 'VC']} />
        <Book title="Trillion Dollar Coach: The Leadership Playbook of Silicon Valley's Bill Campbell"
          address="https://amzn.to/3pfW1Ar"
          author="Eric Schmidt "
          hashtags={['management', 'SiliconValley', 'Google']} />
        <Book title="The Making of a Manager: What to Do When Everyone Looks to You"
          address="https://amzn.to/32orsi0"
          author="Julie Zhuo"
          hashtags={['management', 'Facebook']} />
        <Book title="Radical Candor: Be a Kickass Boss Without Losing Your Humanity"
        ...
        <Book title="The One Minute Manager"
          ...
          hashtags={['management']} />
        <Book title="The Carolina Way: Leadership Lessons from a Life in Coaching"
      ...
      <ul>
        ...
        <Book title="Sons of Wichita: How the Koch Brothers Became America's Most Powerful and Private Dynasty"
          address="https://amzn.to/3l9oup5"
          author="Daniel Schulman"
          hashtags={['UnitedStates', 'politics']} />
        <Book title="Kochland: The Secret History of Koch Industries and Corporate Power in America"
          address="https://amzn.to/3n6VJKf"
          author="Christopher Leonard"
          hashtags={['UnitedStates', 'politics']} />
        <Book title="King Icahn: The Biography of a Renegade Capitalist"
          address="https://amzn.to/3lbHovd"
          author="Mark Stevens"
          hashtags={['UnitedStates', 'finance', 'politics']} />
        <Book title="MBS: The Rise to Power of Mohammed bin Salman"
          address="https://amzn.to/36cb8lG"
          author="Ben Hubbard"
          hashtags={['SaudiArabia', 'politics']} />
        <Book title="The Polyester Prince: The Rise of Dhirubhai Ambani"
          address="https://amzn.to/32kKC8f"
          author="Hamish McDonald"
          hashtags={['India', 'reliance']} />
        <Book title="The Billionaire Raj: A Journey Through India's New Gilded Age"
        ...
        <Book title="Billion Dollar Whale: The Man Who Fooled Wall Street, Hollywood, and the World"
          ...
          author="Bradley Hope"
          hashtags={['Malaysia', 'UAE', '1mdb', 'SovereignWealthFund', 'fraud']} />
        ...
        <Book title="Kingpin: How One Hacker Took Over the Billion-Dollar Cybercrime Underground"
          address="https://amzn.to/2JJnCtf"
          author="Kevin Poulson"
          hashtags={['hacker', 'crime']} />
        <Book title="Ghost in the Wires: My Adventures as the World's Most Wanted Hacker"
          address="https://amzn.to/356xDsE"
          author="Kevin Mitnick"
          hashtags={['tech', 'hacker']} />
        <Book title="Endurance: Shackleton's Incredible Voyage to the Antarctic"
        ...
        <Book title="Genius: The Life and Science of Richard Feynman"
        ...
        <Book title="The House of Morgan: An American Banking Dynasty and the Rise of Modern Finance"
          address="https://amzn.to/3p8sAQA"
          author="Ron Chernow"
          hashtags={['UnitedStates', 'finance', 'banking']} />
        <Book title="Andrew Carnegie"
      ...
      <h3>Industries:</h3>
      <ul>
        <Book title="The Song Machine: Inside the Hit Factory"
          address="https://amzn.to/3eJsf1V"
          author="John Seabrook"
          hashtags={['music']} />
        <Book title="The Mirage Factory: Illusion, Imagination, and the Invention of Los Angeles"
          address="https://amzn.to/2U7c1Gy"
          author="Gary Krist"
          hashtags={['film']} />
        <Book title="Powerhouse: The Untold Story of Hollywood's Creative Artists Agency"
          address="https://amzn.to/356u8T4"
          author="James Miller"
          hashtags={['film', 'hollywood']} />
        <Book title="Blackwater: The Rise of the World's Most Powerful Mercenary Army"
          address="https://amzn.to/32osPxj"
          author="Jeremy Scahill"
          hashtags={['blackwater', 'military']} />
        <Book title="The Cartiers: The Untold Story of the Family Behind the Jewelry Empire"
          address="https://amzn.to/3p7yZvo"
          author="Francesca Cartier Brickell"
          hashtags={['jewelry']} />
        <Book title="Stoned: Jewelry, Obsession, and How Desire Shapes the World"
          address="https://amzn.to/32jNcLZ"
          author="Aja Raden"
          hashtags={['jewelry']} />
        <Book title="Boom: Mad Money, Mega Dealers, and the Rise of Contemporary Art"
          address="https://amzn.to/36ayo3k"
          author="Michael Shnayerson"
          hashtags={['art']} />
        <Book title="The Ride of a Lifetime: Lessons Learned from 15 Years as CEO of the Walt Disney Company"
          address="https://amzn.to/38nysPO"
          author="Robert Iger"
          hashtags={['film', 'disney']} />
        <Book title="Pour Your Heart Into It: How Starbucks Built a Company One Cup at a Time"
        ...
        <Book title="BARE ESSENTIALS: The ALDI Way to Retail Success"
          address="https://amzn.to/3lbllF0"
          author="Dieter Brandes"
          hashtags={['retail', 'aldi', 'UnitedStates']} />
        <Book title="Alibaba: The House That Jack Ma Built"
          address="https://amzn.to/2IjaaMe"
          author="Duncan Clark"
          hashtags={['alibaba', 'China']} />
        <Book title="Empire State of Mind: How Jay-Z Went From Street Corner to Corner Office"
          address="https://amzn.to/3eAO83i"
          author="Zack Greenburg"
          hashtags={['music', 'jay-z']} />
        <Book title="The Idea Factory: Bell Labs and the Great Age of American Innovation"
          address="https://amzn.to/3eKckk4"
          author="Jon Gertner"
          hashtags={['tech', 'BellLabs', 'SiliconValley']} />
        <Book title="Empires of Light: Edison, Tesla, Westinghouse, and the Race to Electrify the World"
          address="https://amzn.to/3lateuu"
          author="Jill Jonnes"
          hashtags={['electricity', 'energy']} />
        <Book title="The Powerhouse: America, China, and the Great Battery War"
          address="https://amzn.to/2Ie4AL6"
          author="Steve Levine"
          hashtags={['battery', 'electricity', 'energy']}
        />
        <Book title="Wind Power: The Struggle for Control of a New Global Industry"
        ...
        <Book title="How to Make a Spaceship: A Band of Renegades, an Epic Race, and the Birth of Private Spaceflight"
          address="https://amzn.to/359jRG0"
          author="Julian Guthrie"
          hashtags={['space']} />
        <Book title="Bottle of Lies: The Inside Story of the Generic Drug Boom"
          address="https://amzn.to/2IcSSjN"
          author="Katherine Eban"
          hashtags={['medicine']} />
        <Book title="Germ Theory: Medical Pioneers in Infectious Diseases"
          address="https://amzn.to/3mWNzns"
          author="Robert Gaynes"
          hashtags={['biology', 'medicine']} />
        <Book title="Plastic: A Toxic Love Story"
          address="https://amzn.to/3k3BqLG"
          author="Susan Freinkel"
          hashtags={['infrastructure', 'material']} />
        <Book title="Concrete Planet: The Strange and Fascinating Story of the World's Most Common Man-Made Material"
          address="https://amzn.to/3paOO4j"
          author="Robert Courland"
          hashtags={['infrastructure', 'material']} />
        <Book title="Steel: From Mine to Mill, the Metal that Made America"
          address="https://amzn.to/3eOv7uF"
          author="Brooke Stoddard"
          hashtags={['steel', 'material']} />
        <Book title="Ninety Percent of Everything: Inside Shipping, the Invisible Industry That Puts Clothes on Your Back, Gas in Your Car, and Food on Your Plate"
          address="https://amzn.to/3p9H02Y"
          author="Rose George"
          hashtags={['logicstics', 'shipping']} />
        <Book title="The Box: How the Shipping Container Made the World Smaller and the World Economy Bigger"
          address="https://amzn.to/2JMnbP0"
          author="Marc Levinson"
          hashtags={['logicstics', 'shipping']} />
        <Book title="Napoleon's Buttons: How 17 Molecules Changed History"
          address="https://amzn.to/2I8T4kq"
          author="Penny Couteur"
          hashtags={['chemistry']} />
        <Book title="A History of World Agriculture: From the Neolithic Age to the Current Crisis"
          address="https://amzn.to/38j0mwx"
          author="Marcel Mazoyer"
          hashtags={['agriculture', 'history']} />
        <Book title="The Sugar Barons: Family, Corruption, Empire, and War in the West Indies"
          address="https://amzn.to/2Ig91oB"
          author="Matthew Parker"
          hashtags={['agriculture', 'sugar', 'history']} />
        <Book title="Cotton: The Biography of a Revolutionary Fiber"
          address="https://amzn.to/38hvbSi"
          author="Stephen Yafa"
          hashtags={['agriculture']} />
        <Book title="Slaughterhouse: The Shocking Story of Greed, Neglect, And Inhumane Treatment Inside the U.S. Meat Industry"
          address="https://amzn.to/3p7hWtc"
          author="Gail Eisnitz"
          hashtags={['meat']} />
        <Book title="Samsung Rising: The Inside Story of the South Korean Giant That Set Out to Beat Apple and Conquer Tech"
